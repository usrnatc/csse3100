// Dafny program Ex08.dfy compiled into C#
...
// Dafny 3.0.0.30203
// Command Line Options: f:\CSSE3100\csse3100\week2\Ex08.dfy /verifyAllModules /compile:3 /spillTargetCode:1 /out:bin\Ex08
// Ex08.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger Triple(BigInteger x)
    {
      ...
      BigInteger _16_y;
      BigInteger _out0;
      _out0 = __default.Double(x);
      _16_y = _out0;
      r = (x) + (_16_y);
      return r;
    }
    public static BigInteger Double(BigInteger x)
    {
      BigInteger r = BigInteger.Zero;
      BigInteger _17_y;
      _17_y = (new BigInteger(2)) * (x);
      r = _17_y;
      return r;
    }
  }
