// Dafny program gcd.dfy compiled into C#
...
// Dafny 3.0.0.30203
// Command Line Options: f:\CSSE3100\csse3100\ass1\gcd.dfy /verifyAllModules /compile:3 /spillTargetCode:1 /out:bin\gcd
// gcd.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    TAIL_CALL_START: ;
      ...
      } else if ((Dafny.Helpers.EuclideanModulus(a, b)).Sign == 0) {
        r = b;
      } else {
        BigInteger _in2 = b;
        BigInteger _in3 = Dafny.Helpers.EuclideanModulus(a, b);
        a = _in2;
        b = _in3;
        goto TAIL_CALL_START;
      }
