// Dafny program lec.dfy compiled into C#
...
// Dafny 3.0.0.30203
// Command Line Options: f:\CSSE3100\csse3100\week2\lec.dfy /verifyAllModules /compile:3 /spillTargetCode:1 /out:bin\lec
// lec.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      return Dafny.Helpers.EuclideanDivision((a) + (b), new BigInteger(2));
    }
    public static BigInteger Triple(BigInteger x)
    {
      BigInteger r = BigInteger.Zero;
      r = __default.Average((new BigInteger(2)) * (x), (new BigInteger(4)) * (x));
      return r;
    }
  }
